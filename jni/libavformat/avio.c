...
static const AVOption options[] = {
    ...
    {"protocol_whitelist", NULL_IF_CONFIG_SMALL("List of protocols that are allowed to be used"), OFFSET(protocol_whitelist), AV_OPT_TYPE_STRING, { .str = NULL },  0, 0, D },
    {"protocol_blacklist", NULL_IF_CONFIG_SMALL("List of protocols that are not allowed to be used"), OFFSET(protocol_blacklist), AV_OPT_TYPE_STRING, { .str = NULL },  0, 0, D },
