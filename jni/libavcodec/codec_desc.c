...
static const AVCodecDescriptor codec_descriptors[] = {
#if !PAMP_CONFIG_NO_VIDEO // Begin PAMP change - strip video codec descriptors
    /* video codecs */
    {
...
#endif // End PAMP change - strip video codec descriptors
    ...
    },
    {
        ...
        .props     = AV_CODEC_PROP_LOSSY,
        .profiles  = NULL_IF_CONFIG_SMALL(ff_aac_profiles), // PAMP: AAC profile-name (ff_aac_profiles under CONFIG_SMALL) deferred with the aacdec.c override re-derivation
    },
    {
        .id        = AV_CODEC_ID_AC3,
        .type      = AVMEDIA_TYPE_AUDIO,
    ...
    /* subtitle codecs */
#if !PAMP_CONFIG_NO_VIDEO // Begin PAMP change - strip subtitle codec descriptors
    {
...
#endif // End PAMP change - strip subtitle codec descriptors
