...
// Begin PAMP change - audio-only build, video path must never be reached
...
// Begin PAMP change - audio-only build. Do nothing here. From logs we're getting here somehow
#if !PAMP_CONFIG_NO_VIDEO
