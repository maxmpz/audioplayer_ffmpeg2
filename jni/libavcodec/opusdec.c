...
#include "decode.h"
#if PAMP_CHANGES // Begin PAMP change - for avctx->internal->skip_samples in flush (gapless after seek)
#include "internal.h"
...
#if PAMP_CHANGES // Begin PAMP change - re-arm initial delay skip for better gapless after seek/flush
