...
// PAMP change - commented out (via #if !PAMP_CHANGES) options which are 0 by default / unused by PA (resampler3
// drives SwrContext via direct struct field writes, not via this AVOption table).
// NOTE: some are used, e.g. in opusdec, be careful. The channel-layout options are kept intact as
// swr_init() (FF_API_OLD_CHANNEL_LAYOUT path) still reads the underlying struct fields.

static const AVOption options[]={
#if FF_API_OLD_CHANNEL_LAYOUT
{"ich"                  , N("set input channel count (Deprecated, use ichl)"),
                                                          OFFSET(user_in_ch_count  ), AV_OPT_TYPE_INT, {.i64=0                    }, 0      , SWR_CH_MAX, PARAM|DEPREC},
{"in_channel_count"     , N("set input channel count (Deprecated, use in_chlayout)"),
                                                          OFFSET(user_in_ch_count  ), AV_OPT_TYPE_INT, {.i64=0                    }, 0      , SWR_CH_MAX, PARAM|DEPREC},
{"och"                  , N("set output channel count (Deprecated, use ochl)"),
                                                          OFFSET(user_out_ch_count ), AV_OPT_TYPE_INT, {.i64=0                    }, 0      , SWR_CH_MAX, PARAM|DEPREC},
{"out_channel_count"    , N("set output channel count (Deprecated, use out_chlayout)"),
                                                          OFFSET(user_out_ch_count ), AV_OPT_TYPE_INT, {.i64=0                    }, 0      , SWR_CH_MAX, PARAM|DEPREC},
{"uch"                  , N("set used channel count")   , OFFSET(user_used_ch_count), AV_OPT_TYPE_INT, {.i64=0                    }, 0      , SWR_CH_MAX, PARAM|DEPREC},
{"used_channel_count"   , N("set used channel count")   , OFFSET(user_used_ch_count), AV_OPT_TYPE_INT, {.i64=0                    }, 0      , SWR_CH_MAX, PARAM|DEPREC},
#endif
...
#if FF_API_OLD_CHANNEL_LAYOUT
{"icl"                  , N("set input channel layout (Deprecated, use ichl)"),
                                                          OFFSET(user_in_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {.i64=0          }, INT64_MIN, INT64_MAX, PARAM|DEPREC, "channel_layout"},
{"in_channel_layout"    , N("set input channel layout (Deprecated, use in_chlayout)"),
                                                          OFFSET(user_in_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {.i64=0          }, INT64_MIN, INT64_MAX, PARAM|DEPREC, "channel_layout"},
{"ocl"                  , N("set output channel layout (Deprecated, use ochl)"),
                                                          OFFSET(user_out_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {.i64=0         }, INT64_MIN, INT64_MAX, PARAM|DEPREC, "channel_layout"},
{"out_channel_layout"   , N("set output channel layout (Deprecated, use out_chlayout)"),
                                                          OFFSET(user_out_ch_layout), AV_OPT_TYPE_CHANNEL_LAYOUT, {.i64=0         }, INT64_MIN, INT64_MAX, PARAM|DEPREC, "channel_layout"},
#endif
{"ichl"                 , N("set input channel layout") , OFFSET(user_in_chlayout ), AV_OPT_TYPE_CHLAYOUT, {.str=NULL             }, 0, 0 , PARAM, "chlayout"},
{"in_chlayout"          , N("set input channel layout") , OFFSET(user_in_chlayout ), AV_OPT_TYPE_CHLAYOUT, {.str=NULL             }, 0, 0 , PARAM, "chlayout"},
{"ochl"                 , N("set output channel layout"), OFFSET(user_out_chlayout), AV_OPT_TYPE_CHLAYOUT, {.str=NULL             }, 0, 0 , PARAM, "chlayout"},
{"out_chlayout"         , N("set output channel layout"), OFFSET(user_out_chlayout), AV_OPT_TYPE_CHLAYOUT, {.str=NULL             }, 0, 0 , PARAM, "chlayout"},
{"uchl"                 , N("set used channel layout")  , OFFSET(user_used_chlayout), AV_OPT_TYPE_CHLAYOUT, {.str=NULL            }, 0, 0 , PARAM, "chlayout"},
{"used_chlayout"        , N("set used channel layout")  , OFFSET(user_used_chlayout), AV_OPT_TYPE_CHLAYOUT, {.str=NULL            }, 0, 0 , PARAM, "chlayout"},
